						...
						<div class="flex flex-col sm:flex-row gap-4">
							<div class="sm:w-1/3 flex-shrink-0">
								<button
									...
									class="w-full cursor-zoom-in group relative"
									aria-label="View full size image"
								>
									<img
										src={imageUrl}
										alt={String(data.product_name || 'Product label')}
										class="w-full h-auto rounded-lg border border-gray-200 shadow-sm object-contain max-h-64 sm:max-h-80 transition-transform group-hover:scale-[1.02]"
									/>
